...
| 7 | 重叠 1–30 分钟，其他情况 | 新建；两个事件 description 末尾各追加 `⚠️ 时间重叠` |
| 8 | 重叠 >30 分钟，其他情况 | 新建；两个事件均追加 `⚠️ 冲突，请确认` |
| 9 | memo 内容与已有事件矛盾 | 新建 flomo 事件；在已有事件 description 末尾追加 `据flomo：可能有出入，请确认` |
